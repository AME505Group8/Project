...
class Worker(QRunnable):
    ...
    def run(self):
        ...
        # from Functions.GUI_Predict_Function_Test import gui_predict_function

        print('I can open your eyes')
        ...
        print('Take you wonder by wonder')

        print(prediction_name)

        print(aircraft_list)

        print('Over, sideways and under')
