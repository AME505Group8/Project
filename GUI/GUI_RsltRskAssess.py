...
# Form implementation generated from reading ui file 'GUI_RsltRskAssess.ui'
#
...
class Ui_GUI_RsltRskAssess(object):
    def setupUi(self, GUI_RsltRskAssess):
        GUI_RsltRskAssess.setObjectName("GUI_RsltRskAssess")
        GUI_RsltRskAssess.resize(800, 600)
        GUI_RsltRskAssess.setMinimumSize(QtCore.QSize(800, 600))
        GUI_RsltRskAssess.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.centralwidget = QtWidgets.QWidget(GUI_RsltRskAssess)
        ...
        self.InputRskAssessButton = QtWidgets.QPushButton(self.ButtonBar)
        self.InputRskAssessButton.setMinimumSize(QtCore.QSize(100, 50))
        self.InputRskAssessButton.setMaximumSize(QtCore.QSize(100, 50))
        font = QtGui.QFont()
        font.setFamily("Tw Cen MT")
        font.setPointSize(12)
...
"color: rgb(255, 255, 255);")
        ...
        self.horizontalLayout_4.addWidget(self.InputRskAssessButton)
...
"color: rgb(255, 255, 255);")
        ...
        GUI_RsltRskAssess.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(GUI_RsltRskAssess)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 22))
        self.menubar.setObjectName("menubar")
        GUI_RsltRskAssess.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(GUI_RsltRskAssess)
        self.statusbar.setObjectName("statusbar")
        GUI_RsltRskAssess.setStatusBar(self.statusbar)

        self.retranslateUi(GUI_RsltRskAssess)
        QtCore.QMetaObject.connectSlotsByName(GUI_RsltRskAssess)

    def retranslateUi(self, GUI_RsltRskAssess):
        _translate = QtCore.QCoreApplication.translate
        GUI_RsltRskAssess.setWindowTitle(_translate("GUI_RsltRskAssess", "MainWindow"))
        self.label_5.setText(_translate("GUI_RsltRskAssess", "Bird Strike Analysis"))
        self.label_6.setText(_translate("GUI_RsltRskAssess", "AME505 Group 8"))
        self.InputRskAssessButton.setText(_translate("GUI_RsltRskAssess", "Back"))
        self.StartButton.setText(_translate("GUI_RsltRskAssess", "Home"))
        self.PrintButton.setText(_translate("GUI_RsltRskAssess", "Print"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    GUI_RsltRskAssess = QtWidgets.QMainWindow()
    ui = Ui_GUI_RsltRskAssess()
    ui.setupUi(GUI_RsltRskAssess)
    GUI_RsltRskAssess.show()
    sys.exit(app.exec_())
