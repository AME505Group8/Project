...
# Form implementation generated from reading ui file 'GUI_InputRskAssess.ui'
#
...
class Ui_GUI_InputRskAssess(object):
    def setupUi(self, GUI_InputRskAssess):
        GUI_InputRskAssess.setObjectName("GUI_InputRskAssess")
        GUI_InputRskAssess.resize(800, 600)
        GUI_InputRskAssess.setMinimumSize(QtCore.QSize(800, 600))
        GUI_InputRskAssess.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.centralwidget = QtWidgets.QWidget(GUI_InputRskAssess)
...
"color: rgb(255, 255, 255);")
        ...
        self.RsltRskAssessButton = QtWidgets.QPushButton(self.ButtonBar)
        self.RsltRskAssessButton.setMinimumSize(QtCore.QSize(100, 50))
        self.RsltRskAssessButton.setMaximumSize(QtCore.QSize(100, 50))
        font = QtGui.QFont()
        font.setFamily("Tw Cen MT")
        font.setPointSize(12)
        self.RsltRskAssessButton.setFont(font)
        self.RsltRskAssessButton.setStyleSheet("background-color: rgb(101, 117, 125);\n"
"color: rgb(255, 255, 255);")
        self.RsltRskAssessButton.setObjectName("RsltRskAssessButton")
        self.horizontalLayout_4.addWidget(self.RsltRskAssessButton)
        self.verticalLayout_2.addWidget(self.ButtonBar)
        self.MainContent.raise_()
        self.TitleBlock.raise_()
        self.ButtonBar.raise_()
        GUI_InputRskAssess.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(GUI_InputRskAssess)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 22))
        self.menubar.setObjectName("menubar")
        GUI_InputRskAssess.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(GUI_InputRskAssess)
        self.statusbar.setObjectName("statusbar")
        GUI_InputRskAssess.setStatusBar(self.statusbar)

        self.retranslateUi(GUI_InputRskAssess)
        QtCore.QMetaObject.connectSlotsByName(GUI_InputRskAssess)

    def retranslateUi(self, GUI_InputRskAssess):
        _translate = QtCore.QCoreApplication.translate
        GUI_InputRskAssess.setWindowTitle(_translate("GUI_InputRskAssess", "MainWindow"))
        self.label_5.setText(_translate("GUI_InputRskAssess", "Bird Strike Analysis"))
        self.label_6.setText(_translate("GUI_InputRskAssess", "AME505 Group 8"))
        self.label_2.setText(_translate("GUI_InputRskAssess", "Airport"))
        self.label_4.setText(_translate("GUI_InputRskAssess", "Airport:"))
        self.StartButton.setText(_translate("GUI_InputRskAssess", "Home"))
        self.RsltRskAssessButton.setText(_translate("GUI_InputRskAssess", "Submit"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    GUI_InputRskAssess = QtWidgets.QMainWindow()
    ui = Ui_GUI_InputRskAssess()
    ui.setupUi(GUI_InputRskAssess)
    GUI_InputRskAssess.show()
    sys.exit(app.exec_())
